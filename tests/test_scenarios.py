...
class TestTextsTypeMappings:
    ...
    def test_type_ru_keys(self):
        from client_bot.texts import TYPE_RU
    ...
    def test_order_status_ru_covers_all(self):
        from client_bot.texts import ORDER_STATUS_RU
    ...
    def test_partner_status_ru_keys(self):
        from client_bot.texts import PARTNER_STATUS_RU
...
class TestPartnerMenuTexts:
    ...
    def test_contains_key_buttons(self):
        from client_bot.texts import PARTNER_MENU_TEXTS, Btn
    ...
    def test_is_tuple(self):
        from client_bot.texts import PARTNER_MENU_TEXTS
...
class TestClientTextsFormatStrings:
    ...
    def test_time_not_available_format(self):
        from client_bot.texts import Client
    ...
    def test_profile_remod_warning_format(self):
        from client_bot.texts import Partner
...
class TestMetroGraph:
    ...
    def test_transfer_graph_populated(self):
        from client_bot.services.metro_graph import TRANSFER_GRAPH
...
class TestHaversine:
    def test_same_point(self):
        from client_bot.services.ranking import haversine_km
...
class TestFindNearestMetro:
    def test_finds_closest(self):
        from client_bot.services.ranking import find_nearest_metro_by_coords
...
class TestSvcCoversTime:
    ...
    def test_no_time_str(self):
        from client_bot.services.ranking import _svc_covers_time
...
class TestFindNearestValidTime:
    ...
    def test_before_open(self):
        from client_bot.services.ranking import _find_nearest_valid_time
...
class TestMetroProximityScore:
    def test_same_station(self):
        from client_bot.services.ranking import MetroProximityStrategy, RankingContext
        from client_bot.domain.models import Service
    ...
    def test_no_metro_data(self):
        from client_bot.services.ranking import (
...
class TestMetroTextInput:
    ...
    def test_valid(self, val):
        from client_bot.domain.schemas import MetroTextInput
...
class TestProblemDescription:
    ...
    def test_valid(self, val):
        from client_bot.domain.schemas import ProblemDescription
...
class TestModelNameInput:
    ...
    def test_valid(self, val):
        from client_bot.domain.schemas import ModelNameInput
...
class TestBrandNameInput:
    ...
    def test_valid(self, val):
        from client_bot.domain.schemas import BrandNameInput
...
class TestClientKeyboards:
    ...
    def test_service_type_kb(self):
        from client_bot.ui.keyboards import service_type_kb
    ...
    def test_calendar_kb_buttons(self):
        from client_bot.ui.keyboards import calendar_kb
    ...
    def test_time_slots_kb(self):
        from client_bot.ui.keyboards import time_slots_kb
...
class TestAllHandlerImports:
    def test_client_common(self):
        from client_bot.handlers.common import router

        assert router is not None

    def test_client_order(self):
        from client_bot.handlers.order import router

        assert router is not None

    def test_client_admin(self):
        from client_bot.handlers.admin import router
...
class TestFSMReminderPrefixes:
    def test_is_form_state_with_prefix(self):
        from client_bot.services.fsm_reminder import FSMActivityMiddleware
...
class TestSheetsWriter:
    def test_all_columns_have_getters(self):
        from client_bot.core.config import SHEETS_COLUMNS
        from client_bot.services.sheets_writer import _FIELD_GETTERS
    ...
    def test_type_map_rev(self):
        from client_bot.services.sheets_writer import _TYPE_MAP_REV
